...
function female_clothes(tep) {
    $.ajax({
        ...
        success: function (data) {
            ...
            console.log(data.woman_cody_img[1])
        }
    });
...
function showError(error) {
    switch (error.code) {
        ...
        case error.PERMISSION_DENIED:
            ...
            console.log(lon[city_name_reverse[city]], lat[city_name_reverse[city]]);
            cityCall();
            break;
    ...
    $.ajax({
            ...
            success: function (data) {
                ...
                if (temp <= 4) {
                    ...
                    $('.clothes1_2').css({
                        "background": "url(./images/5~8남.png)",
                        'background-repeat': 'no-repeat',
                        'background-position': 'center center',
                    ...
                    $('.clothes1_2').css({
                        "background": "url(./images/9~11남.png)",
                        'background-repeat': 'no-repeat',
                        'background-position': 'center center',
                    ...
                    $('.clothes1_2').css({
                        "background": "url(./images/12~16남.png)",
                        'background-repeat': 'no-repeat',
                    ...
                    $('.clothes1_2').css({
                        "background": "url(./images/17~19남.png)",
                        'background-repeat': 'no-repeat',
                        'background-position': 'center center',
                        'background-size': '50% 80%'
                    });
                    ...
                    $('.clothes1_2').css({
                        "background": "url(./images/20~22남.png)",
                        'background-repeat': 'no-repeat',
                        'background-position': 'center center',
                        'background-size': '40% 80%'
                    });
                    ...
                    $('.clothes1_2').css({
                        "background": "url(./images/23~27남.png)",
                        'background-repeat': 'no-repeat',
                        'background-position': 'center center',
                        'background-size': '40% 80%'
                    });
