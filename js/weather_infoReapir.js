...
/////////////////////////////css 수정 후 작동 여부 확인후 피드백 주세요!//////////////////////////
///각 수치에 따른 색 변경 추가해 주세요!

////// 뒷면 (위치에 따른 기상 정보->미세,초미세)
...
///////////////////자외선 지수 치수에 따른 변화 (css에 class값 넣어 색 추가만 하면 됩니다.)
        if (uv > 7.0 ) {
            uvi = (`<li class='Bad'>${uv}</li>`)
        } else if(uv > 5.0) {
            uvi= (`<li class='Normal'>${uv}</li>`)
        } else {
            uvi= (`<li class='Good'>${uv}</li>`)
        }
    } 
